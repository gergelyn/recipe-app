...
@section('content')
    ...
    <h1 class="text-lg font-bold mb-6 text-yellow-600">Poszt szerkesztése</h1>
{{--    <a href="{{ route('posts.index') }}" class="rounded-full bg-blue-600 text-white px-4 py-2">Vissza</a>--}}
    ...
    <form action="{{ route('posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <button type="submit" class="m-auto p-3 border border-yellow-600 bg-yellow-600 rounded-full text-white hover:border-yellow-700 hover:bg-yellow-700">Szerkesztés befejezése</button>
    </form>
    </div>
@endsection

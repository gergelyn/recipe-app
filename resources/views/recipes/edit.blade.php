...
@section('content')
    ...
    @endif
    <form action="{{ route('recipes.update', $recipe->id) }}" method="POST" class="flex flex-col w-1/2" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mb-4 ingredients">
            ...
            <div class="ingredient my-2">
                <input type="number" name="measurement_amounts[]" id="measurement_amounts" class="border-2 border-black rounded-md" placeholder="Mennyiség" value={{ $ingredient->measurement_qty->amount }}>
                ...
                <input type="text" name="ingredient_names[]" id="ingredient_names" class="border-2 border-black rounded-md" placeholder="Alapanyag" value={{ $ingredient->ingredient_name->ingredient_name }}>
            </div>
            @endforeach
        </div>
        ...
        <div class="mb-4 instructions">
            ...
            <div class="instruction my-2">
                <input type="text" name="instructions[]" id="instruction" class="border-2 border-black rounded-md" placeholder="Teendô" value="{{ $instruction->instruction_text }}">
            </div>
            @endforeach
        </div>
